...
function initFluxiDelPost(){
    ...
    jQuery('.l-card-slider .js-del-post').click(function(e){
        e.preventDefault();
        ...
        if (isConfirm == true) {
            ...
            jQuery('.l-card-slider .js-notify').html('');
            ...
            jQuery.ajax({
                ...
                success: function(data){
                    ...
                    if(data[0].validation == 'error'){
                        ...
                        jQuery('#js-idp-'+theIdp).addClass('is-none');
                        jQuery('#js-idp-'+theIdp).animate({ borderLeftWidth: '0px' }, 200 , 'linear', function() {
                            jQuery('#js-idp-'+theIdp).remove();
                        });
